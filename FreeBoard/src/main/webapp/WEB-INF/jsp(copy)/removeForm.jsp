...
<table class="table">
	...
	<tr class="d-grid gap-2 d-md-block">
		<td align="center"><input type="submit" class="btn btn-danger btn-lg" value="삭제" <%=logId !=null && logId.equals(bvo.getWriter()) ? "": "disabled" %>></td>
...
<script>
	...
	location.href = 'board.do?page=<%=pg%>&bno=<%=bvo.getBoardNo() %>&searchCondition=<%=sc==null ? "" : sc %>&keyword=<%=kw==null ? "" : kw %>'
});
